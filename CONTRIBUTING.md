# How to contributing to mochiOS?
mochiOSへの貢献方法は多岐にわたります。少しだけ例を挙げると、
...
この文章には、mochiOSへ貢献する方法を書いています。

失敗を恐れないでください！私たちはいつでも挑戦を歓迎します。

### バグの報告の仕方
[Issue](https://github.com/tas0dev/mochiOS/issues)に行き、「New issue」ボタンを押します。
